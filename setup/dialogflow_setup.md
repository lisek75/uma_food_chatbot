...
- **Event**: `WELCOME`
- **Responses**: Hi👋 This is UMA Bot. How can I help you today? You can say 'New Order' 🍱, 'Track Order' 🔍 or 'Store Hours' 🕒.
- Click "Save"
...
- **Responses**: I didn't understand😕 You can say 'New Order' 🍱, 'Track Order' 🔍 or 'Store Hours' 🕒.
- Click "Save"
...
- **Fulfillment**: Activate 'Enable Webhook call for this intent'
- **Add follow-up intent**: order.add - context: ongoing-order - yes
- Click "Save"

#### order.add - context: ongoing-order - yes
- **Context**:
    - Input context : `ongoing-order`
    - Output context : `ongoing-order` (Lifespan : 5)
- **Training Phrases**:
